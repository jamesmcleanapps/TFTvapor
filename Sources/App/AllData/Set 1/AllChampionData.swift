...
class Champions {
    ...
    init() {
        ...
        // MARK: VOLIBEAR
        volibear = Champion(name: "volibear", nickname: "The Thunder's Roar", tier: .three, cost: 3, rating: .B, ultimate: Ultimate(name: "thunder claws", description: "Volibear empowers his attacks to deal bonus damage that chains between enemies and applies on-hit effects"), championOrigin: [.glacial], championClass: [.brawler], bestItems: [items.rapidFirecannon, items.guinsoosRageblade, items.redBuff], stats: Stats(health: 750, armor: 30, magicResist: 20, attackDamage: 70, attackSpeed: 0.65, attackRange: 1))
