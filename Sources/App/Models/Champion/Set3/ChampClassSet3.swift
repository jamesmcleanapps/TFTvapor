...
enum ChampClassSet3: String, CaseIterable, Codable {
    ...
    static func getClassInfo(classStr: String) -> Details? {
        ...
        case "infiltrator":
            ...
            benefit2: "4  -  75% Bonus Attack Speed.",
        ...
        case "protector":
            ...
            benefit1: "2  -  25% Maximum Health Shield",
            benefit2: "4  -  30% Maximum Health Shield",
            benefit3: "6  -  40% Maximum Health Shield"
            )
        case "sniper":
