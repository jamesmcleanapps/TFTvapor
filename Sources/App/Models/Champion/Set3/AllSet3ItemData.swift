...
class ItemsSet3 {
    ...
    init() {
        ...
        // MARK: RED BUFF
        redBuff = CombinedItem(name: "red buff", bonus: "Attacks deal burn damage equal to 3% of the enemy's maximum health per second for 10 seconds. Reduces enemy healing by 30%.", rating: .A, recipe: [chainVest, giantsBelt])
